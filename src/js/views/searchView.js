...
// may want to use a different method than inserting  all the HTML
    ...
    `<li>
      <a class="results__link results__link--active" href="#${recipe.idDrink}">
          ...
          <div class="results__data">
              ...
              <p class="results__author">To be served in a ${recipe.strGlass}</p>
          </div>
      </a>
  </li>`;
...
export const renderResults = (recipes, page = 1, resPerPage = 10) => {
  ...
  recipes.splice(start, end).forEach(renderRecipe);
